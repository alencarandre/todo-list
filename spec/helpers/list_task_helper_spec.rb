...
RSpec.describe ListTaskHelper, type: :helper do
  ...
  describe '#list_list_task_mark_as_closed_link' do
    context 'when pass screen :mine' do
      it 'has link to close list' do
        element = list_list_task_mark_as_closed_link(task, :mine)
    ...
    context 'when pass screen :public' do
      it 'has not link to close list' do
        element = list_list_task_mark_as_closed_link(task, :public)
        href = list_list_task_mark_as_closed_path(task.list, task)
  ...
  describe '#list_list_task_mark_as_opened_link' do
    context 'when pass screen :mine' do
      it 'has link to open list' do
        element = list_list_task_mark_as_opened_link(task, :mine)
    ...
    context 'when pass screen :public' do
      it 'has not link to open list' do
        element = list_list_task_mark_as_opened_link(task, :public)
        href = list_list_task_mark_as_opened_path(task.list, task)
  ...
  describe '#edit_list_list_task_link' do
    context 'when pass screen :mine' do
      it 'has link to open list' do
        element = edit_list_list_task_link(task, :mine)
    ...
    context 'when pass screen :public' do
      it 'gives nil' do
        element = edit_list_list_task_link(task, :public)
  ...
  describe '#list_list_task_new_link' do
    context 'when pass screen :mine' do
      it 'has link to open list' do
        element = list_list_task_new_link(task, :mine)
    ...
    context 'when pass screen :public' do
      it 'gives nil' do
        element = list_list_task_new_link(task, :public)
        expect(element).to be_nil
      end
    end
  end
  ...
  describe '#list_list_task_link' do
    context 'when pass screen :mine' do
      it 'has link to open list' do
        element = list_list_task_link(task, :mine)
    ...
    context 'when pass screen :public' do
      it 'gives nil' do
        element = list_list_task_link(task, :public)
        expect(element).to be_nil
      end
    end
  end
